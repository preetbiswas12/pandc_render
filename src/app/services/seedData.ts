...
export function seedDatabase() {
  ...
  const fabricProducts = [
    ...
    },
    {
      ...
      description: 'Luxurious net fabric with intricate beading and sequin work. Perfect for bridal wear.',
      images: ['https://images.unsplash.com/photo-1558769132-cb1aea3c8565?w=800'],
    ...
    },
    {
      ...
      description: 'Hand embroidered silk with traditional paisley motifs and intricate threadwork.',
      images: ['https://images.unsplash.com/photo-1617038260897-41a1f14a8ca0?w=800'],
  ...
  // Insert data into Supabase (only if tables are empty)
  async function seed() {
    try {
      ...
      console.log(`Seeded ${fabricProducts.length} products`);

      for (const banner of banners) {
        await db.create('banners', banner);
      }
      console.log(`Seeded ${banners.length} banners`);

      for (const coupon of coupons) {
        await db.create('coupons', coupon);
      }
