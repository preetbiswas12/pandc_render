    ...
    <div ref={pageRef} className="min-h-screen">
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-6 lg:px-[60px] py-4 md:py-6 lg:py-8">
        ...
        <button
          ...
          className="lg:hidden flex items-center gap-2 mb-4 px-4 py-2 bg-white border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors"
        >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[250px,1fr] gap-4 md:gap-6 lg:gap-8">
          {/* Filters Sidebar */}
          <div className={`${isMobileSidebarOpen ? 'block' : 'hidden'} lg:block space-y-3 md:space-y-4`}>
